  ...
  return (
    <div className="main">
      ...
      <article className="article">
        ...
        <p className="article-para">
            The idea is to return a beautiful 3D-ish looking letter's image or rather unique ones to the user rather than the default ones we see in most applications while making sure to provide a variety of sizes, sets (1 for now), and formats (2 for now) for free. They can also be non 3D-ish, but for now, it only contains one set, called set1, which looks 3D-ish.
        </p>
        ...
        <span className="img-description">Stylish avatar-letter provided by avatar-letter</span>
